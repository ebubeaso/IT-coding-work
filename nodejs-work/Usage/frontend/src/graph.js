...
},{"d3-path":18}],5:[function(require,module,exports){
...
},{"d3-array":1}],7:[function(require,module,exports){
...
},{"d3-dispatch":8,"d3-quadtree":20,"d3-timer":28}],14:[function(require,module,exports){
...
},{"d3-color":5}],18:[function(require,module,exports){
...
},{"d3-color":5,"d3-interpolate":17}],23:[function(require,module,exports){
...
},{"d3-array":1,"d3-format":14,"d3-interpolate":17,"d3-time":27,"d3-time-format":26}],24:[function(require,module,exports){
...
},{"d3-array":1}],28:[function(require,module,exports){
...
},{"d3-color":5,"d3-dispatch":8,"d3-ease":11,"d3-interpolate":17,"d3-selection":24,"d3-timer":28}],30:[function(require,module,exports){
...
},{"d3-dispatch":8,"d3-drag":9,"d3-interpolate":17,"d3-selection":24,"d3-transition":29}],31:[function(require,module,exports){
'use strict';
...
},{"d3-array":1,"d3-axis":2,"d3-brush":3,"d3-chord":4,"d3-color":5,"d3-contour":6,"d3-delaunay":7,"d3-dispatch":8,"d3-drag":9,"d3-dsv":10,"d3-ease":11,"d3-fetch":12,"d3-force":13,"d3-format":14,"d3-geo":15,"d3-hierarchy":16,"d3-interpolate":17,"d3-path":18,"d3-polygon":19,"d3-quadtree":20,"d3-random":21,"d3-scale":23,"d3-scale-chromatic":22,"d3-selection":24,"d3-shape":25,"d3-time":27,"d3-time-format":26,"d3-timer":28,"d3-transition":29,"d3-zoom":30}],32:[function(require,module,exports){
/*
object-assign
(c) Sindre Sorhus
@license MIT
...
},{"_process":41,"object-assign":32,"react":37}],34:[function(require,module,exports){
/** @license React v17.0.2
...
},{"object-assign":32,"react":37}],35:[function(require,module,exports){
(function (process){(function (){
/** @license React v17.0.2
...
},{"_process":41,"object-assign":32}],36:[function(require,module,exports){
/** @license React v17.0.2
...
},{"object-assign":32}],37:[function(require,module,exports){
(function (process){(function (){
'use strict';
...
},{"./cjs/react-jsx-runtime.development.js":33,"./cjs/react-jsx-runtime.production.min.js":34,"_process":41}],39:[function(require,module,exports){
/**
...
exports.Main = exports.Phone = exports.XboxGraph = void 0;
...
var XboxGraph = function XboxGraph() {
  ...
  (0, _react.useEffect)(function () {
    fetch("http://10.0.0.31:9900/usage").then(function (response) {
      ...
      d3.select("p#xbox").append("svg").attr("width", 650).attr("height", 600).style("padding", "20pt").style("border", "1px solid black");
      var svg = d3.select("svg"); // the constants

      var width = parseInt(svg.attr("width"));
      var height = parseInt(svg.attr("height"));
      var graphWidth = width - margins.left - margins.right;
      var graphHeight = height - margins.top - margins.bottom; // Make the x and y scales and gridlines

      var xScale = d3.scaleBand().domain(result.map(function (d) {
        return d.day;
      })).range([margins.left * 2, graphWidth]).padding(0.5);
      var xGridlines = d3.axisBottom(xScale).tickSize(-graphHeight).tickFormat(function () {
        return "";
      });
      var yScale = d3.scaleLinear().domain([0, d3.max(result, function (d) {
        return d.hours;
      })]).range([graphHeight, margins.top]);
      var yGridlines = d3.axisLeft(yScale).tickSize(-graphWidth).tickFormat(function () {
        return "";
      }); // make the X gridlines

      svg.append("g").attr("class", "xGrid").attr("transform", "translate(" + margins.left.toString() + ", " + graphHeight.toString() + ")").attr("stroke", "darkgray").call(xGridlines); // make the Y gridlines

      svg.append("g").attr("class", "yGrid").attr("transform", "translate(" + (margins.left * 3).toString() + " ,0)").attr("stroke", "darkgray").call(yGridlines); // make the X and y axes

      svg.append("g").attr("class", "x-axis").attr("transform", "translate(" + margins.left.toString() + "," + graphHeight.toString() + ")").style("font-size", "10pt").call(d3.axisBottom(xScale));
      svg.append("g").attr("class", "y-axis").attr("transform", "translate(" + (margins.left * 3).toString() + ", 0)").call(d3.axisLeft(yScale)); // make the axis labels
      // x-axis label

      svg.append("text").attr("class", "x-label").attr("text-anchor", "middle").attr("x", width / 2).attr("y", height - 2).style("font-size", "12pt").text("Days of the Week"); // y-axis label

      svg.append("text").attr("class", "y-label").attr("text-anchor", "middle").attr("x", 0 - height / 2).attr("y", margins.right).attr("dy", "0.5em").style("font-size", "14pt").attr("transform", "rotate(-90)").text("Hours Spent"); // make the line
      ...
      svg.append("path").datum(result).attr("class", "line-plot").attr("fill", "none").attr("stroke", "darkcyan").attr("d", lineGenerator).attr("transform", "translate(" + (margins.left * 2).toString() + ", 0)"); // make circles to signify the data points

      svg.selectAll("circle").data(result).join("circle").attr("r", 4).attr("fill", "black").attr("cx", function (d) {
        return xScale(d.day);
      }).attr("cy", function (d) {
        return yScale(d.hours);
  ...
  return (0, _jsxRuntime.jsxs)("div", {
    children: [(0, _jsxRuntime.jsx)("h1", Object.assign({
      className: "Title"
    }, {
      children: "Hours Spent on the Xbox"
...
var Phone = function Phone() {
  (0, _react.useEffect)(function () {
    fetch("http://10.0.0.31:9900/phone").then(function (response) {
      ...
      var theData = data;
      console.log(theData);
      d3.select("p#phone").append("svg").attr("width", 650).attr("height", 600).style("padding", "20pt").style("border", "1px solid black");
      var canvas = d3.select("svg"); // set up the variables
      ...
      var chartHeight = phoneHeight - margins.top - margins.bottom; // set up the scales and grids

      var scaleX = d3.scaleBand().domain(theData.map(function (d) {
        return d.day;
      })).range([margins.left, chartWidth]).padding(0.5);
      var xGrid = d3.axisBottom(scaleX).tickSize(-chartHeight).tickFormat(function () {
        return "";
      });
      canvas.append("g").attr("class", "xGrid").attr("transform", "translate(" + margins.left.toString() + "," + chartHeight.toString() + ")").attr("stroke", "darkgray").call(xGrid);
      var scaleY = d3.scaleLinear().domain([0, d3.max(theData, function (d) {
        return d.hours;
      })]).range([chartHeight, margins.top]);
      var yGrid = d3.axisLeft(scaleY).tickSize(-chartWidth).tickFormat(function () {
        return "";
      });
      canvas.append("g").attr("class", "yGrid").attr("transform", "translate(" + (margins.left * 2).toString() + " ,0)").call(yGrid); // set up the axes

      canvas.append("g").attr("class", "x-axis").attr("transform", "translate(" + margins.left.toString() + "," + chartHeight.toString() + ")").style("font-size", "10pt").call(d3.axisBottom(scaleX));
      canvas.append("g").attr("class", "y-axis").attr("transform", "translate(" + (margins.left * 2).toString() + ",0)").style("font-size", "10pt").call(d3.axisLeft(scaleY)); // make the axis labels
      // x-axis label

      canvas.append("text").attr("class", "x-label").attr("text-anchor", "middle").attr("x", phoneWidth / 2).attr("y", phoneHeight - 2).style("font-size", "12pt").text("Days of the Week"); // y-axis label

      canvas.append("text").attr("class", "y-label").attr("text-anchor", "middle").attr("x", 0 - phoneHeight / 2).attr("y", margins.right / 2).attr("dy", "0.2em").style("font-size", "14pt").attr("transform", "rotate(-90)").text("Hours Spent"); // make the line generator

      var lineGen = d3.line().x(function (d) {
        return scaleX(d.day);
      }).y(function (d) {
        return scaleY(d.hours);
      }).curve(d3.curveMonotoneX); // now to draw the line

      canvas.append("path").datum(theData).attr("class", "line-plot").attr("fill", "none").attr("stroke", "darkcyan").attr("d", lineGen).attr("transform", "translate(" + (margins.left * 2).toString() + ", 0)"); // make some circles as data points

      canvas.selectAll("circle").data(theData).join("circle").attr("r", 4).attr("fill", "black").attr("cx", function (d) {
        return scaleX(d.day);
      }).attr("cy", function (d) {
        return scaleY(d.hours);
      }).attr("transform", "translate(" + (margins.left * 2).toString() + " ,0)");
  ...
  return (0, _jsxRuntime.jsxs)("div", {
    children: [(0, _jsxRuntime.jsx)("h1", Object.assign({
      ...
      children: "Hours Spent on the Phone"
    }), void 0), (0, _jsxRuntime.jsx)("p", {
      id: "phone"
    }, void 0)]
  }, void 0);
...
var Main = function Main() {
  ...
  return (0, _jsxRuntime.jsxs)("div", {
    children: [(0, _jsxRuntime.jsx)("h1", Object.assign({
      ...
      children: "Hello there sport!"
    }), void 0), (0, _jsxRuntime.jsx)("p", Object.assign({
      style: Style
    }, {
      children: "This is the main page"
    }), void 0)]
  }, void 0);
};
...
},{"d3":31,"react":37,"react/jsx-runtime":38,"regenerator-runtime/runtime":39}],41:[function(require,module,exports){
